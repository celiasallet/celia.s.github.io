document.addEventListener("DOMContentLoaded", function () {
    ...
    const articles = ['article.yml', 'article1.yml', 'article2.yml', 'article3.yml', 'article4.yml', 'article5.yml', 'article6.yml', 'article7.yml', 'article8.yml', 'article9.yml', 'article10.yml'];
